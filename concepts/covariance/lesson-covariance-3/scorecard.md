# Scorecard: Covariance: The Leftover of the Product Rule  (lesson-covariance-3)

| # | gate | owner | status | evidence |
|---|------|-------|--------|----------|
| 1 | Source fidelity | Dept 1 | ✅ | every problem cited+sourced — GB pp.47-48 (#2,#6); see source-dossier.md + brief.md |
| 2 | Math correctness | Dept 3 Verify | ✅ | engine reproduces explore Cov→1/4; win Cov=1/4; mastery Cov∈{0,1/4}, ρ=1; covariance.test.ts + lesson-covariance-3.factcheck.test.ts green; validate-fixtures §3f cross-check green |
...
| 9 | Inclusivity gate | Dept 3 Verify | ✅ | validate-fixtures inclusivity + mastery-challenge gates pass for lesson-covariance-3 (added to GATED + MASTERY_LESSONS — non-vacuous) |
