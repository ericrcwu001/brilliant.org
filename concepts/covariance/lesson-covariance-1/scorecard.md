# Scorecard:   (lesson-covariance-1)

| # | gate | owner | status | evidence |
|---|------|-------|--------|----------|
| 1 | Source fidelity | Dept 1 | ✅ | every problem cited+sourced — ; see source-dossier.md + brief.md |
| 2 | Math correctness | Dept 3 Verify | ✅ | engine reproduces ; covariance.test.ts + lesson-covariance-1.factcheck.test.ts green; validate-fixtures §3f cross-check green |
...
| 9 | Inclusivity gate | Dept 3 Verify | ✅ | validate-fixtures inclusivity + mastery-challenge gates pass for lesson-covariance-1 (added to GATED + MASTERY_LESSONS — non-vacuous) |
