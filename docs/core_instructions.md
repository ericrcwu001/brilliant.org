...
*Model the product on Brilliant, but pick a single subject and go deep instead of wide.*
...
Submit a 1-page brainlift documenting your AI-first build process and the point of view you developed. Cover:

1. Tools and workflow: what AI coding tools you used and how.
2. Prompting strategies: 3 to 5 prompts that worked, including how you got AI to help build interactive lessons in your subject.
3. Phase decisions: which AI features you chose and skipped in Phase 2, and which learning science principles you added in Phase 3 and why.
4. Code analysis: rough split of AI-generated vs hand-written.
5. Key learnings: the spiky opinions and insights you walked away with.
...
- **Phase 2 AI:** OpenAI or Anthropic Claude for problem generation and hints, with a math engine like SymPy or math.js for ground-truth checks where relevant.
