#!/usr/bin/env tsx
// interviews/_build/render-markov-chains-md.ts
// Renders interviews/course-markov-chains.md from interviews/course-markov-chains.json.
// Full mirror: includes interviewerPrompt, generatorPrompt, templates table, and
// each question's hidden record. No engine imports — JSON.parse only. Deterministic output.

import { readFileSync, writeFileSync } from 'node:fs'

const JSON_PATH = 'interviews/course-markov-chains.json'
const MD_PATH = 'interviews/course-markov-chains.md'
